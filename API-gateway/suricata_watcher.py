...
# Detect OS and set Suricata log path
BREW_PREFIX = os.environ.get("BREW_PREFIX", "/usr/local")  # default Homebrew prefix if not set
# EVE_LINUX = "/var/log/suricata/eve.json"
EVE_MAC = os.path.join(BREW_PREFIX, "/opt/homebrew/var/log/suricata/eve.json")
